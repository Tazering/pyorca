...
class MovingGoalPublisher:
    def __init__(self):
        ...
        self.goal_pub = rospy.Publisher(f"/r1/orca_goal", PoseStamped, queue_size=1)
        self.trajectory_sub = rospy.Subscriber(f"/r1/adjusted_traj", Path, self.trajectory_callback)
...
if __name__ == '__main__':
    rospy.init_node('moving_goal_publisher1')
    try:
        MovingGoalPublisher()
        rospy.spin()
